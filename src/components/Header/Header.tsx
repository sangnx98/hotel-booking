...
export default function Header() {
  ...
  return (
    <Box sx={{ flexGrow: 1}}>
      <AppBar 
        sx={{backgroundColor: "white", position: 'fixed', zIndex: '1000', top:'0'}}
        position="static">
        ...
        <Link to='/'>
          ...
          <Search sx={{ border: '1px solid #b9c9be', boxShadow: '2px -1px 5px 1px rgba(0,0,0,0.26)' }}>
            <SearchIconWrapper>
              <SearchIcon />
            </SearchIconWrapper>
            <StyledInputBase
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' }, alignItems: 'center' }}>
            <Link to='/host'>
              <Typography variant="subtitle2" component="h2" sx={{display: 'flex', justifyContent:'center', alignItems:'center', color: 'black', mr:'2rem'}}>
                    Host
              </Typography>
              </Link>
              {(values) ?
